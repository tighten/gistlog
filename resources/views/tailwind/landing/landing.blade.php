...
<html lang="en">
    ...
    <body>
        @include('tailwind.partials.flash-messages')
        @include('tailwind.landing.nav')
        @include('tailwind.landing.intro')
        @include('tailwind.landing.cover')
        @include('tailwind.landing.instructions')
        @include('tailwind.landing.features')
        @include('tailwind.landing.footer')
        @yield('scripts')
    </body>
</html>
