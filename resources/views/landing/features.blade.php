<div class="bg-white w-full pt-8">
    <div class="container mx-auto text-center pt-4 pb-2">
        ...
        <p class="md:w-4/5 mx-auto text-grey leading-normal text-base md:px-8 my-6">GistLog posts may be easy to create, but we didn't skimp on features. All the features you expect from a developer-focused blogging platform, with almost no setup.</p>
    </div>
</div>
