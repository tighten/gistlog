...
5. Go to https://github.com/settings/developers and create a Oauth app and after that create a token here https://github.com/settings/tokens that has access right to Gist
